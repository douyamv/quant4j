...
public class MysqlGenerator {
    ...
    private static String packageName="temp";    //文件路径

    private static String authorName="yang";     //作者
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("root")
                        .setUrl("jdbc:mysql://124.156.120.130:3306/quant?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
